...
export default function Hero() {
  ...
  return (
    <div className="flex justify-center items-center flex-col h-screen fixed w-full -z-10">
      ...
      <h4 className="md:text-4xl text-3xl md:tracking-widest tracking-normal mt-4 font-semibold bg-linear-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-transparent text-center">
        FRONTEND DEVELOPER
      </h4>
